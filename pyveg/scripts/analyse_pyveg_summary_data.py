...
try:
    from pyveg.src.zenodo_utils import download_file, get_deposition_id, list_files
except:
...
def barplot_plots(df, output_dir):
    ...
    plt.figure()
    ax30 = sns.barplot(
        x="name", y="S2_offset50_mean_max", hue="total_precipitation_mean", data=df
    )
    ...
    ax31 = sns.barplot(
        x="name",
        y="S2_offset50_mean_max",
        hue="S2_offset50_mean_Lag-1 AC (0.99 rolling window)",
        data=df,
    )
...
def scatter_plots(df, output_dir):
    ...
    plt.figure()
    ax = sns.scatterplot(
        y="S2_offset50_mean_mean",
        x="total_precipitation_mean",
        data=df,
        hue="S2_offset50_mean_pattern_type",
        palette="Accent_r",
        edgecolor="k",
        linewidth=1,
    )
    ...
    plt.figure()
    ax4 = sns.scatterplot(
        y="S2_offset50_mean_Lag-1 AC (0.99 rolling window)",
        x="S2_offset50_mean_mean",
        data=df,
        hue="S2_offset50_mean_pattern_type",
        palette="Accent_r",
        edgecolor="k",
    ...
    plt.figure()
    ax5 = sns.scatterplot(
        y="S2_offset50_mean_Variance (0.99 rolling window)",
        x="S2_offset50_mean_mean",
        data=df,
        hue="S2_offset50_mean_pattern_type",
        palette="Accent_r",
    ...
    plt.figure()
    ax6 = sns.scatterplot(
        y="S2_offset50_mean_Kendall tau Lag-1 AC (0.5 rolling window)",
        x="S2_offset50_mean_mean",
        data=df,
        hue="S2_offset50_mean_pattern_type",
        palette="Accent_r",
    ...
    plt.figure()
    ax7 = sns.scatterplot(
        y="S2_offset50_mean_Kendall tau Variance (0.5 rolling window)",
        x="S2_offset50_mean_mean",
        data=df,
        hue="S2_offset50_mean_pattern_type",
        palette="Accent_r",
    ...
    ax11 = sns.scatterplot(
        ...
        x="S2_offset50_mean_Variance (0.99 rolling window)",
        data=df,
        hue="S2_offset50_mean_pattern_type",
        palette="Accent_r",
        edgecolor="k",
    ...
    ax12 = sns.scatterplot(
        y="total_precipitation_mean",
        x="S2_offset50_mean_Lag-1 AC (0.99 rolling window)",
        data=df,
        hue="S2_offset50_mean_pattern_type",
        palette="Accent_r",
        edgecolor="k",
    ...
    plt.figure()
    ax15 = sns.scatterplot(
        y="S2_offset50_mean_Lag-1 AC (0.99 rolling window) Seasonal",
        x="S2_offset50_mean_max",
        data=df,
        hue="S2_offset50_mean_pattern_type",
        palette="Accent_r",
    ...
    plt.savefig(
        os.path.join(output_dir, "offset50max_vs_offset50AR1_0.99_Seasonal.png")
    )

    plt.figure()
    ax16 = sns.scatterplot(
        y="S2_offset50_mean_Variance (0.99 rolling window) Seasonal",
        x="S2_offset50_mean_max",
        data=df,
        hue="S2_offset50_mean_pattern_type",
        palette="Accent_r",
    ...
    plt.savefig(
        os.path.join(output_dir, "offset50max_vs_offset50Variance_0.99_Seasonal.png")
    )

    plt.figure()
    ax17 = sns.scatterplot(
        y="S2_offset50_mean_Lag-1 AC (0.99 rolling window) Seasonal",
        x="total_precipitation_mean",
        data=df,
        hue="S2_offset50_mean_pattern_type",
    ...
    plt.savefig(
        os.path.join(output_dir, "precipitationmean_vs_offset50AR1_0.99_Seasonal.png")
    )

    plt.figure()
    ax18 = sns.scatterplot(
        y="S2_offset50_mean_Variance (0.99 rolling window) Seasonal",
        x="total_precipitation_mean",
        data=df,
        hue="S2_offset50_mean_pattern_type",
    ...
    plt.savefig(
        os.path.join(
            output_dir, "precipitationmean_vs_offset50Variance_0.99_Seasonal.png"
        )
    )

    plt.figure()
    ax19 = sns.scatterplot(
        y="offset50_cb_return_rate",
        x="S2_offset50_mean_max",
        data=df,
        hue="S2_offset50_mean_pattern_type",
        palette="Accent_r",
    ...
    plt.figure()
    ax21 = sns.scatterplot(
        y="ndvi_cb_return_rate",
        x="S2_ndvi_mean_max",
        data=df,
        hue="S2_offset50_mean_pattern_type",
        palette="Accent_r",
...
def correlation_plots(df, output_dir):
    ...
    selected_df = df[
        [
            ...
            "S2_offset50_mean_mean",
            "S2_offset50_mean_max",
            "S2_offset50_mean_Lag-1 AC (0.99 rolling window)",
            "S2_offset50_mean_Variance (0.99 rolling window)",
            "latitude",
            "longitude",
        ]
    ]
    df_labels = [
        ...
        "Ofset50 mean",
        "Offset50 max",
        "Offset50 AR1 (0.99 r.w)",
        "Offset50 variance (0.99 r.w)",
        "latitude",
        "longitude",
    ]
...
def boxplot_plots(df, output_dir):
    ...
    plt.figure()
    ax23 = sns.boxplot(
        x="S2_offset50_mean_pattern_type",
        y="S2_offset50_mean_max",
        data=df,
        hue="S2_offset50_mean_pattern_type",
        palette="Accent_r",
...
def process_input_data(input_location):
    ...
    if input_location == "zenodo" or input_location == "zenodo_test":
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ts_filenames = [
                download_file(f, deposition_id, tmpdir, is_test)
        ...
        df_list = [
            pd.read_csv(os.path.join(input_location, filename))
...
def analyse_pyveg_summary_data(input_location, output_dir):
    ...
    df["offset50_cb_return_rate"] = (df["S2_offset50_mean_CB_fit_alpha"] ** 2).divide(
        2.0
    )
...
def main():
    ...
    parser.add_argument(
        "--output_dir", help="location where analysis plots will be put.", default="."
    )
    ...
    # run analysis code
    analyse_pyveg_summary_data(args.input_location, args.output_dir)

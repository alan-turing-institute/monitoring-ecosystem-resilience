...
def barplot_plots(df, output_dir):
    ...
    plt.figure()
    ax31 = sns.barplot(x='name', y='S2_offset50_mean_max',
                       hue='S2_offset50_mean_Lag-1 AC (0.99 rolling window)', data=df)
...
def scatter_plots(df, output_dir):
    ...
    plt.figure()
    ax4 = sns.scatterplot(y="S2_offset50_mean_Lag-1 AC (0.99 rolling window)", x="S2_offset50_mean_mean",
                          data=df, hue="S2_offset50_mean_pattern_type", palette="Accent_r", edgecolor="k", linewidth=1)
    ...
    plt.figure()
    ax5 = sns.scatterplot(y="S2_offset50_mean_Variance (0.99 rolling window)", x="S2_offset50_mean_mean",
                          data=df, hue="S2_offset50_mean_pattern_type", palette="Accent_r", edgecolor="k", linewidth=1)
    ...
    plt.figure()
    ax6 = sns.scatterplot(y="S2_offset50_mean_Kendall tau Lag-1 AC (0.5 rolling window)", x="S2_offset50_mean_mean",
                          data=df, hue="S2_offset50_mean_pattern_type", palette="Accent_r", edgecolor="k", linewidth=1)
    ...
    plt.figure()
    ax7 = sns.scatterplot(y="S2_offset50_mean_Kendall tau Variance (0.5 rolling window)", x="S2_offset50_mean_mean",
                          data=df, hue="S2_offset50_mean_pattern_type", palette="Accent_r", edgecolor="k", linewidth=1)
    ...
    plt.figure()
    ax9 = sns.scatterplot(y="S2_offset50_mean_Lag-1 AC (0.99 rolling window)", x="S2_offset50_mean_max",
                          data=df, hue="S2_offset50_mean_pattern_type", palette="Accent_r", edgecolor="k", linewidth=1)
    ...
    plt.figure()
    ax10 = sns.scatterplot(y="S2_offset50_mean_Variance (0.99 rolling window)", x="S2_offset50_mean_max",
                           data=df, hue="S2_offset50_mean_pattern_type", palette="Accent_r", edgecolor="k", linewidth=1)
    ...
    plt.figure()
    ax11 = sns.scatterplot(y="total_precipitation_mean", x="S2_offset50_mean_Variance (0.99 rolling window)",
                           data=df, hue="S2_offset50_mean_pattern_type", palette="Accent_r", edgecolor="k", linewidth=1)
    ...
    plt.figure()
    ax12 = sns.scatterplot(y="total_precipitation_mean", x="S2_offset50_mean_Lag-1 AC (0.99 rolling window)",
                           data=df, hue="S2_offset50_mean_pattern_type", palette="Accent_r", edgecolor="k", linewidth=1)
    ...
    plt.figure()
    ax13 = sns.scatterplot(y="S2_offset50_mean_max", x="S2_ndvi_mean_max", data=df,
                           hue="S2_offset50_mean_pattern_type", palette="Accent_r", edgecolor="k", linewidth=1)
    ...
    plt.figure()
    ax14 = sns.scatterplot(y="S2_offset50_mean_mean", x="S2_ndvi_mean_mean", data=df,
                           hue="S2_offset50_mean_pattern_type", palette="Accent_r", edgecolor="k", linewidth=1)
...
def boxplot_plots(df, output_dir):
    ...
    plt.figure()
    ax23 = sns.boxplot(x="S2_offset50_mean_pattern_type", y="S2_offset50_mean_max",
                       data=df, hue="S2_offset50_mean_pattern_type", palette="Accent_r")
    ...
    plt.figure()
    ax24 = sns.boxplot(x="S2_offset50_mean_pattern_type", y="S2_offset50_mean_mean",
                       data=df, hue="S2_offset50_mean_pattern_type", palette="Accent_r")

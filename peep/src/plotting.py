...
from peep.src.data_analysis_utils import (
    get_corrs_by_lag,
    get_datetime_xs,
    get_kendell_tau,
    get_max_lagged_cor,
    ...
    def make_plot(
        ...
        if "total_precipitation" in df.columns:
            ...
            try:
                ...
                print(
                    "Warning - lagged correlations file not found - call plot_autocorrelation_function() first to print correlations on plot"
                )
